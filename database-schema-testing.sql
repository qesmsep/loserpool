-- Testing Database Schema for The Loser Pool
-- This version disables RLS for testing purposes

-- Enable necessary extensions
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Create users table (testing version)
...
-- Create purchases table (testing version)
...
-- Create matchups table (testing version)
...
-- Create picks table (testing version)
...
-- Create weekly_results table (testing version)
...
-- Create invitations table (testing version)
...
-- DISABLE RLS FOR TESTING (remove this in production!)
...
-- Function to handle new user creation (for testing)
