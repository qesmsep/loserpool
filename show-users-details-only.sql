-- Show ONLY the detailed list of users and picks that should be eliminated
-- This will show you the specific users, their picks, and why they should be eliminated
